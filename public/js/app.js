...
function initAdmin() {
  ...
  var orders = [];
  var markup;
  axios__WEBPACK_IMPORTED_MODULE_0___default().get('/admin/oredrs', {
    headers: {
...
var addToCart = document.querySelectorAll('.add-to-29cart');
var cartCounter = document.querySelector('#cartCounter');

function updateCart(idli) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('/update-cart', idli).then(function (res) {
    console.log(res);
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var idli = JSON.parse(btn.dataset.idli);
    updateCart(idli);
  });
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkidli"] = self["webpackChunkidli"] || [];
